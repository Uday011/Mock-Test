...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-slate-200/80 bg-white text-slate-600 mt-16 sm:mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5 mb-3">
              <div className="w-8 h-8 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-white font-bold text-sm shadow-xs">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-slate-500">
              <span className="flex items-center gap-1"><CheckCircle className="w-3.5 h-3.5 text-emerald-600" /> Negative Marking</span>
              <span className="flex items-center gap-1"><ShieldCheck className="w-3.5 h-3.5 text-blue-600" /> Server Scoring</span>
              <span className="flex items-center gap-1"><Zap className="w-3.5 h-3.5 text-amber-600" /> Real-time Timer</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/tests/create" className="hover:text-slate-900 transition-colors">Create Test</Link></li>
            </ul>
          </div>
