    ...
    return (
      <AppShell>
        <div className="max-w-md mx-auto my-16 p-6 bg-white rounded-md border border-[#ebebeb] text-center space-y-4">
          ...
          <h3 className="font-semibold text-[#37352f] text-base">Creator Not Found</h3>
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-md p-5 sm:p-6 border border-[#ebebeb] space-y-5">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-[4px] bg-[#fbf3db] border border-[#f1e0b5] text-[#4d3800] flex items-center justify-center font-bold text-xl sm:text-2xl shrink-0">
                {creator.name?.charAt(0) || 'F'}
              </div>
              <div className="space-y-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <h1 className="text-lg sm:text-xl font-bold text-[#37352f] tracking-tight">
                    {creator.name}
                  </h1>
            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
              <button
                ...
                className={`flex-1 md:flex-initial px-4 py-1.5 rounded-[4px] text-xs font-medium transition-colors ${
                  creator.is_following
                    ? 'bg-[#f7f6f3] text-[#37352f] border border-[#ebebeb] hover:bg-[#f1f1ef]'
              ...
              <button
                onClick={handleShare}
                className="p-1.5 rounded-[4px] border border-[#ebebeb] bg-white text-[#787774] hover:bg-[#f7f6f3] transition-colors"
          ...
          <div className="space-y-1.5 pt-3 border-t border-[#ebebeb]">
            ...
            <p className="text-xs sm:text-sm text-[#37352f] leading-relaxed max-w-3xl">
              {creator.bio}
            </p>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              {(creator.specializations || []).map((subj: string) => (
                <span
                  key={subj}
                  className="text-[11px] px-2 py-0.5 rounded-[3px] bg-[#f7f6f3] text-[#37352f] border border-[#ebebeb]"
                >
                  {subj}
                </span>
              ))}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-3 border-t border-[#ebebeb]">
            <div className="p-3 rounded-[4px] bg-[#fcfbf9] border border-[#ebebeb]">
            ...
            <div className="p-3 rounded-[4px] bg-[#fcfbf9] border border-[#ebebeb]">
              ...
              <div className="flex items-center gap-1.5 mt-1">
                <Award className="w-3.5 h-3.5 text-[#d9730d]" />
                <span className="font-semibold text-sm text-[#37352f]">
            ...
            <div className="p-3 rounded-[4px] bg-[#fcfbf9] border border-[#ebebeb]">
              ...
              <div className="flex items-center gap-1.5 mt-1">
                <Star className="w-3.5 h-3.5 fill-[#d9730d] text-[#d9730d]" />
                <span className="font-semibold text-sm text-[#37352f]">
        ...
        <div className="p-1.5 bg-white rounded-md border border-[#ebebeb] flex items-center justify-between gap-3 text-xs">
        ...
        {testSeries.filter((s: any) => {
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-semibold text-[#37352f] flex items-center gap-2 border-b border-[#ebebeb] pb-1.5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {testSeries
                ...
                .map((s) => (
                  <div key={s.id} className="p-4 bg-white rounded-md border border-[#ebebeb] flex flex-col justify-between space-y-3 hover:bg-[#fcfbf9] transition-colors">
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        <span className="text-[10px] font-mono px-1.5 py-0.5 rounded-[3px] bg-[#fbf3db] text-[#4d3800] border border-[#f1e0b5]">
                    ...
                    <div className="pt-2.5 border-t border-[#ebebeb] flex items-center justify-between text-xs">
        ...
        <div className="space-y-3">
          ...
          {tests.filter((t: any) => {
            ...
            <div className="bg-white border border-[#ebebeb] rounded-md p-6 text-center text-xs text-[#787774]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {tests
                ...
                .map((test) => (
                  <div
                    key={test.id}
                    className="bg-white rounded-md border border-[#ebebeb] p-4 hover:bg-[#fcfbf9] transition-colors flex flex-col justify-between space-y-3"
                  >
                    <div className="space-y-2">
                      ...
                      <Link
                        href={`/tests/${test.id}`}
                        className="font-semibold text-sm text-[#37352f] hover:underline transition-colors line-clamp-2"
                      >
                        {test.title}
                      </Link>
                      ...
                      <div className="flex items-center gap-2 pt-0.5">
                        <span className="text-[10px] font-mono px-1.5 py-0.5 rounded-[3px] bg-[#f7f6f3] text-[#787774] border border-[#ebebeb]">
                    ...
                    <div className="pt-2.5 border-t border-[#ebebeb] flex items-center gap-2">
        ...
        <div className="p-3.5 bg-[#f7f6f3] rounded-md border border-[#ebebeb] text-xs text-[#787774] flex items-start gap-2.5">
          <ShieldCheck className="w-4 h-4 text-[#787774] shrink-0 mt-0.5" />
          <div className="space-y-0.5">
            <span className="font-medium text-[#37352f]">Academic Pedagogy & Copyright Integrity Notice</span>
