...
export default function TestInstructionsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 space-y-6 sm:space-y-8">
      {/* Title Card */}
      <div className="bg-white rounded-3xl p-5 sm:p-8 border border-slate-200 shadow-sm space-y-3">
        ...
        <h1 className="text-xl sm:text-3xl font-black text-slate-900 tracking-tight">{test.title}</h1>

        {test.description && (
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed max-w-2xl">{test.description}</p>
        )}

        {/* Quick Highlights */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 pt-4 border-t border-slate-100">
          <div className="p-3 bg-slate-50 rounded-xl">
            <span className="text-[10px] sm:text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Duration</span>
            <span className="text-xs sm:text-sm font-bold text-slate-900 flex items-center gap-1.5 mt-0.5">
          ...
          <div className="p-3 bg-slate-50 rounded-xl">
            <span className="text-[10px] sm:text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Questions</span>
            <span className="text-xs sm:text-sm font-bold text-slate-900 flex items-center gap-1.5 mt-0.5">
          ...
          <div className="p-3 bg-slate-50 rounded-xl">
            <span className="text-[10px] sm:text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Total Marks</span>
            <span className="text-xs sm:text-sm font-bold text-slate-900 flex items-center gap-1.5 mt-0.5">
          ...
          <div className="p-3 bg-slate-50 rounded-xl">
            <span className="text-[10px] sm:text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Marking</span>
            <span className="text-xs sm:text-sm font-bold text-blue-800 flex items-center gap-1 mt-0.5 font-mono">
      ...
      <div className="bg-white rounded-3xl p-5 sm:p-8 border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="pt-4 border-t border-slate-100 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-3">
            ...
            <div className="flex items-center gap-3 p-2.5 rounded-xl bg-amber-50/70 border border-amber-200 text-xs">
            ...
            <div className="flex items-center gap-3 p-2.5 rounded-xl bg-emerald-50/70 border border-emerald-200 text-xs">
            ...
            <div className="flex items-center gap-3 p-2.5 rounded-xl bg-purple-50/70 border border-purple-200 text-xs">
            ...
            <div className="flex items-center gap-3 p-2.5 rounded-xl bg-blue-50/70 border border-blue-200 text-xs sm:col-span-2 lg:col-span-2">
        ...
        <div className="pt-6 border-t border-slate-100 space-y-4">
          <label className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200 cursor-pointer min-h-[48px]">
            <input
              type="checkbox"
              checked={declared}
          ...
          <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-2">
            <Link
              href="/dashboard"
              className="min-h-[44px] px-5 py-2.5 text-xs font-bold text-slate-600 hover:bg-slate-100 rounded-xl flex items-center justify-center text-center"
            >
              Cancel & Return
            </Link>
